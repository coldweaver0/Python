...
data = ['flashdisk',100,'harddisk']
print(data)
index_flashdisk = data.index('flashdisk')                       # Mencari index suatu data pada list dengan
...
data[1] = 200                                                   # Mengupdate suatu list, data yang sebelumnya berada pada index tersebut akan direplace
